...
<head>
    ...
    <title>Sinar Pancasila - Balikpapan</title>
    ...
    <link href="asset/css/stylelp.css" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html"><span>Sinar Pancasila</span></a></h1>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        <h1>SMP, SMA dan SMK <span>Sinar Pancasila</span></h1>
                        <h2>Telaga Sari Rt.31 No.13, Telaga Sari, Kec. Balikpapan Kota, Kota Balikpapan Prov. Kalimantan
                            Timur</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5"
                        ...
                        <p>Yayasan Sinar Pancasila Balikpapan adalah Sekolah Swasta yang berdiri sejak tahun 1972. Dibawah
                            ...
                            terbaik yang mampu bersaing di sekolah lanjutan atas.</p>

                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                            <div class="icon"><i class="bx bx-fingerprint"></i></div>
                            <h4 class="title"><a href="">Visi</a></h4>
                            <p class="description">SMP Sinar Pancasila mempunyai VISI Berprestasi,Berbudi pekerti yang
                                luhur,Berwawasan IMTAQ dan IMTEK serta Berkarakter Pancasila.</p>
                        </div>

                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                            <div class="icon"><i class="bx bx-gift"></i></div>
                            <h4 class="title"><a href="">Misi</a></h4>
                            <p class="description">1. Mewujudkan Peningkatan mutu Pendidikan dalam Kelulusan.</p>
                            <p class="description">2. Melaksanakan Pengembangan IMTAQ dan IMTEK.</p>
                            <p class="description">3. Melaksanakan ektrakurikuler baca dan tulis Al-Qur’an.</p>
                            <p class="description">4. Menyelenggarakan Pendidikan Karakter bangsa serta Pendalaman
                                Pancasila.</p>
                            <p class="description">5. Melaksanakan Peningkatan mutu di bidang non Akademik melalui
                                pelatihan olah raga dan seni budaya.</p>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="asset/img/smk.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
                        <h3>SMKS Sinar Pancasila</h3>
                        <p class="fst-italic">
                            JL. TELAGA SARI GN.PASIR, Kota Balikpapan, Kalimantan Timur
                        </p>
                        <p>
                            SMK SINAR PANCASILA adalah salah satu satuan pendidikan dengan jenjang SMK di Klandasan Ilir, Kec. Balikpapan Kota, Kota Balikpapan, Kalimantan Timur. Dalam menjalankan kegiatannya, SMK SINAR PANCASILA berada di bawah naungan Kementerian Pendidikan dan Kebudayaan.


                        </p>
                        <ul>
                            <li><i class="bi bi-check"></i> SMAS SINAR PANCASILA memiliki akreditasi B, berdasarkan
                                sertifikat 458/BAN-SM/SK/20Pembelajaran di SMK SINAR PANCASILA dilakukan pada Siang. Dalam seminggu, pembelajaran dilakukan selama 6 hari.
                            </li>
                            <li><i class="bi bi-check"></i> SMK SINAR PANCASILA memiliki akreditasi B, berdasarkan sertifikat 032/BAN-SM/SK/2019
                            </li>
                           

                        </ul>
                        <p>
                            SMK SINAR PANCASILA menyediakan listrik untuk membantu kegiatan belajar mengajar. Sumber listrik yang digunakan oleh SMK SINAR PANCASILA berasal dari PLN. SMK SINAR PANCASILA menyediakan akses internet yang dapat digunakan untuk mendukung kegiatan belajar mengajar menjadi lebih mudah. Provider yang digunakan SMK SINAR PANCASILA untuk sambungan internetnya adalah Telkom Speedy.
                        </p>
                    </div>
                </div>
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="asset/img/sma.jpg" class="img-fluid" alt="">
                    </div>
                    ...
                    <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Jl.Telagasari No.13 Rt.31 Kel.Telagasari Balikpapan Kota.</p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope"></i>
                                <h4>Email:</h4>
                                <p>smpspbpn@yahoo.co.id</p>
                            </div>
