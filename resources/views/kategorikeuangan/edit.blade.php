                    ...
                    <div class="card-body">
                        <div class="p-3">
                            <form action="/kategorikeuangan/{{ $kategorikeuangan->id }}" method="POST"
                                ...
                                @csrf
                                <div class="mb-3 row">
                                    <label for="nis" class="col-sm-2 col-form-label">Nama Keuangan</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="mb-3 row">
                                    <label for="namaLengkap" class="col-sm-2 col-form-label">Kategori Keuangan</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="mb-3 row">
                                    <label for="namaLengkap" class="col-sm-2 col-form-label">Tempat LahirDeskripsi</label>
                                    <div class="col-sm-10">
